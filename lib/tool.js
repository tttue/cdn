(function (global, factory) {
  ...
  function showLoading(){
    if (!document.getElementById('local_loading')) {
      document.body.innerHTML += '<div id="local_loading" style="display: none"><div  id="box-loading"><div class="lds-box-inside"><div class="lds-roller"><div></div><div></div><div></div><div></div><div></div><div></div><div></div><div></div></div><div class="loading-text text-center">Loading...</div></div></div></div>'
    ...
    var cssId = 'loading_css'  // you could encode the css path itself to generate id..
    if (!document.getElementById(cssId)) {
      ...
      link.rel = 'stylesheet'
      link.type = 'text/css'
      link.href = 'https://tttue.github.io/cdn/lib/css/loading.css'
      link.media = 'all'
